...
<h3>Update Course - College</h3>
<div class=" container form-control">


<form method="post" action="<?php echo URLROOT; ?>/collegecourses/update/<?php echo $data['id']; ?>">
<input type="text" name="course_id" style="text-transform:uppercase;" placeholder="Course ID" value="<?php echo $data['collegeCoursesById']->CourseID ?>">
<input type="text" name="course_desc" style="text-transform:capitalize;" placeholder="Course Description" value="<?php echo $data['collegeCoursesById']->CourseDesc ?>">
<input readonly type="text" name="department_code" style="text-transform:capitalize;" value="<?php echo $data['collegeCoursesById']->DepartmentCode ?>">
